...
<html lang="en">
 <head>
   ...
   <title>SecretDiary | Log In</title>
     ...
     <div class="container">
       ...
       <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="email" name="loginEmail" class="form-control" id="exampleInputEmail1" placeholder="Email"
                value="">
        ...
        <button type="submit" name="submitLogInButton" class="btn btn-default
